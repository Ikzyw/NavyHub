...
function Library.CreateWindow(title,subtitle,size,version)
	...
	self.close = Instance.new("ImageLabel")
	...
	self.close.Position = UDim2.new(0.945, 0, 0.2, 0)
	...
	self.ImageButton = Instance.new("ImageLabel")
	...
	self.ImageButton.Position = UDim2.new(0.897, 0, 0.35, 0)
	...
	self.ImageButton_2 = Instance.new("ImageLabel")
	...
	self.ImageButton_2.Position = UDim2.new(0.835, 0, 0.29, 0)
	...
	btnclose3.Position = UDim2.new(0, -2 , 0, -2)
...
function tab:AddBigBanner(config)
    ...
    -- MAIN
    Banner.Size = UDim2.new(0, 360, 0, 120)
